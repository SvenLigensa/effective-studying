...
\begin{frame}{Overview}
    \begin{tbox}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=.22\paperwidth]{10_resources/DA_Conv.png}
            \includegraphics[height=.22\paperwidth]{10_resources/3b1b_Conv.png}
            \vspace{-0.5em}
...
\setbgimage{10_resources/SyntaxSemantics_50}
\section{Syntax $\ne$ Semantics}
\begin{frame}{Syntax $\ne$ Semantics}
    \begin{tbox}
        \begin{itemize}
