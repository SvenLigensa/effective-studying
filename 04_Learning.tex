...
\begin{frame}{Overview}
    \begin{tbox}
        \begin{itemize}
            ...
            \end{itemize}
            \item Getting information \red{out} of your brain (not \red{in}) \todo{Source]} %  Powerful Teaching: Unleash the Science of Learning, Ch. 2 (URL: https://katalogplus.uni-muenster.de/discovery/fulldisplay?context=PC&vid=49HBZ_ULM:VU2&search_scope=MyInst_and_CI&tab=Everything&docid=cdi_askewsholts_vlebooks_9781119521853)
...
\begin{frame}{Practice Like an Expert}
    \todo{Fill in with content on how to practice like an expert}
\end{frame}
